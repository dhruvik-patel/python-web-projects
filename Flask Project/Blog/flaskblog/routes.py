...
@app.route('/home')
def home():
    page =  request.args.get('page', 1, type=int)          # URL : ?page=3    : return 3
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Yout account has been updated', 'success')
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'You have successfully updated post!','success')
